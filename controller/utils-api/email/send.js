...
router.post("/send", async function (req, res) {
  try {
    const { userId, username, emailButton, emailBody } = req.body;
          ...
          Body: [
            {
              ...
              Content: `<html dir="ltr" lang="en" class="focus-outline-visible" lazy-loaded="true" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office"><head>
						...
						<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #f1f1f1;">
							...
							<div style="font-family: Helvetica,Arial,sans-serif;min-width:1000px;overflow:auto;line-height:2">
								<div style="margin:50px auto;width:70%;padding:20px 0">
									...
									<a href="https://nursefax.com" style="font-size:1.4em;color: #00466a;text-decoration:none;font-weight:600">nursefax.com</a>
									</div>
                  ...
                  ${
                    emailButton.show &&
                    `<a style="background: #00466a;margin: 0 auto;width: max-content;padding: 5px 10px;color: #fff;border-radius: 4px;" href=${emailButton.href}>${emailButton.title}</a>`
                  }
