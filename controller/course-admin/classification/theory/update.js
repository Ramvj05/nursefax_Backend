...
const TheoryClassificationClass = require("../../../../class/classification/theory.class");
...
router.put("/update/:id", authorizer, async function (req, res) {
  ...
  try {
    ...
    if (
      ...
      const payload = new TheoryClassificationClass(req.body).getModel();

      console.log(payload);

      const updatedcategory = await TheoryClassificationModel.findOneAndUpdate(
        {
          deleted: false,
          _id: id,
        },
